...
public class PrimeCalculatorTest {
    ...
    public void testCalculateFirstFivePrimes(PrimeCalculationStrategy strategy) {
    ...
    @ParameterizedTest
    @MethodSource("strategyProvider")
    public void testCalculateZeroPrimes(PrimeCalculationStrategy strategy) {
    ...
    @ParameterizedTest
    @MethodSource("strategyProvider")
    public void testCalculateFirstTenPrimes(PrimeCalculationStrategy strategy) {
        PrimeCalculator calculator = new PrimeCalculator(strategy, new FileOutputStrategy("primes.txt"));
